...
class EditCourseScreen extends StatefulWidget {
  static String id = "edit_course_screen";
  @override
...
class _EditCourseScreenState extends State<EditCourseScreen> {
  ...
  TextEditingController titleTextEditingController = TextEditingController(text: "Computer Network");
  TextEditingController lecturerTextEditingController = TextEditingController(text: "Cuong Do");
  TextEditingController locationTextEditingController= TextEditingController(text: "F102");
  TextEditingController durationTextEditingController = TextEditingController(text: "180");
  TextEditingController noteTextEditingController = TextEditingController(text: "Interesting course!");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title:Text("Edit Course"), //title aof appbar
          ...
          actions: <Widget>[
            IconButton(
              ...
              onPressed: () {
                // do something
                Navigator.of(context).pushNamed(CourseListScreen.id);
              },
            )
          ],
                        ...
                        Container(
                          ...
                          child: DropdownButtonHideUnderline(
                              child: DropdownButton2(
                                buttonHeight: inputHeight - gap,
                                itemHeight: inputHeight - gap,
